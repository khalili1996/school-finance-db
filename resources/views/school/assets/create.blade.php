...
<div class="container-fluid px-4">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('school.assets.store') }}" method="POST">
                @csrf
                <div class="row">
                    {{-- کد اموال (دستی) --}}
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="asset_code" class="form-control @error('asset_code') is-invalid @enderror"
                               value="{{ old('asset_code') }}" maxlength="30" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="custodian" class="form-control" value="{{ old('custodian') }}" placeholder="نام شخص یا دفتر">
                    </div>

                    {{-- تاریخ خرید (شمسی) --}}
                    <div class="col-md-3 mb-3">
                        <label class="form-label">تاریخ خرید (شمسی) <span class="text-danger">*</span></label>
                        <input type="text" name="purchase_date" class="form-control" value="{{ old('purchase_date', \App\Helpers\JalaliHelper::todayJalali()) }}" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="status" class="form-select" required>
                            ...
                            <option value="transferred" {{ old('status') == 'transferred' ? 'selected' : '' }}>انتقال</option>
                            <option value="broken" {{ old('status') == 'broken' ? 'selected' : '' }}>خراب</option>
                            <option value="scrap" {{ old('status') == 'scrap' ? 'selected' : '' }}>اسقاط</option>
                        </select>
                    </div>
                </div>
