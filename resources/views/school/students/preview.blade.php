            ...
            <tr>
                <td style="width:50%; vertical-align:top; padding:0 5px 0 0;">
                    <table class="info-table">
                        ...
                        {{-- 📅 تاریخ تولد شمسی --}}
                        <tr><td class="label">تاریخ تولد</td><td class="value">{{ $student->birth_date ? \App\Helpers\JalaliHelper::toJalali($student->birth_date) : ($student->birth_year ?? '—') }}</td></tr>
                ...
                <td style="width:50%; vertical-align:top; padding:0 0 0 5px;">
                    <table class="info-table">
                        ...
                        <tr><td class="label">سکونت فعلی</td><td class="value">{{ $student->address ?? '—' }}</td></tr>
                        {{-- 📅 تاریخ ثبت‌نام شمسی --}}
                        <tr><td class="label">تاریخ ثبت‌نام</td><td class="value">{{ $student->enrollment_date ? \App\Helpers\JalaliHelper::toJalali($student->enrollment_date) : '—' }}</td></tr>
