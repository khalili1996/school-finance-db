...
<div class="receipt-container">
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="value">{{ $transaction->transaction_date }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="value">{{ $transaction->cashbox->name ?? '—' }}</td>
        </tr>
        ...
        <tr>
            ...
            <td class="value">{{ number_format($transaction->amount) }} ؋</td>
        </tr>
        @if($transaction->type === 'transfer')
        <tr>
            <td class="label">صندوق مقصد</td>
            <td class="value">{{ $transaction->toCashbox->name ?? '—' }}</td>
        </tr>
        @endif
    </table>
