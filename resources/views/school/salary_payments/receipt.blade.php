...
<div class="receipt-container">
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="value">{{ $payment->salary->employee->first_name }} {{ $payment->salary->employee->last_name }}</td>
        </tr>
        <tr>
            <td class="label">ماه</td>
            <td class="value">{{ $payment->salary->month->name ?? '—' }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="value">{{ $payment->cashbox->name ?? '—' }}</td>
        </tr>
        @if($payment->notes)
        <tr>
