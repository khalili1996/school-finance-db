...
<head>
    ...
    <style>
        ...
        .danishform { font-size: 22px; color: #1e3a5f; margin-bottom: 5px; letter-spacing: 1px; }
        ...
        .btn {
            padding: 8px 18px; margin: 0 5px; border: none; border-radius: 20px;
            cursor: pointer; font-size: 13px; text-decoration: none; display: inline-block; font-weight: 500;
        }
        .btn-print { background: #1e3a5f; color: #fff; }
        .btn-pdf  { background: #b8860b; color: #fff; }
        ...
        @media print {
            ...
            .preview-container { box-shadow: none; padding: 10px; border: none; }
...
<body>
    <div class="preview-container">
        <div class="btn-group">
    <button class="btn btn-print" onclick="window.print()"><i class="fas fa-print"></i> چاپ</button>
</div>

        <div class="header">
            <div class="school-name"><?php echo e($student->school->name ?? 'مکتب'); ?></div>
            <div class="danishform">فرم مشخصات دانش‌آموز </div>
<div>
    سال تعلیمی:
    <?php if(isset($activeYear)): ?>
        <?php echo e($activeYear->name); ?>
            ...
            <tr>
                <td style="width:50%; vertical-align:top; padding:0 5px 0 0;">
                    <table class="info-table">
                        ...
                        <tr><td class="label">تاریخ تولد</td><td class="value"><?php echo e($student->birth_date ? \App\Helpers\JalaliHelper::toJalali($student->birth_date) : ($student->birth_year ?? '—')); ?></td></tr>
                ...
                <td style="width:50%; vertical-align:top; padding:0 0 0 5px;">
                    <table class="info-table">
                        ...
                        <tr><td class="label">سکونت فعلی</td><td class="value"><?php echo e($student->address ?? '—'); ?></td></tr>
                        
                        <tr><td class="label">تاریخ ثبت‌نام</td><td class="value"><?php echo e($student->enrollment_date ? \App\Helpers\JalaliHelper::toJalali($student->enrollment_date) : '—'); ?></td></tr>
...
<?php /**PATH E:\school_finance_db\resources\views\school\students\preview.blade.php ENDPATH**/ ?>