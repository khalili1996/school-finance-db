<?php $__env->startSection('title', 'شهریه دانش‌آموزان'); ?>
...
<div class="container-fluid p-0">
    ...
    <div class="sticky-toolbar bg-white shadow-sm border-bottom px-3 py-2 mb-3">
        <div class="d-flex align-items-center flex-wrap gap-2">
            ...
            <div class="btn-group" role="group">
                <a href="<?php echo e(route('school.student-fees.create')); ?>"
            ...
            <div class="btn-group" role="group">
    <a href="<?php echo e(route('school.payments.index')); ?>"
       ...
       title="مشاهده و مدیریت تمام پرداخت‌ها">
        <i class="fas fa-list-ul ms-1"></i> مدیریت پرداخت‌ها
            ...
            <div class="btn-group" role="group">
                <a href="<?php echo e(route('school.student-fees.print', request()->query())); ?>"
                   target="_blank"
                   class="btn btn-outline-info rounded-pill px-3 py-2"
                   title="چاپ گزارش جدول شهریه">
                    <i class="fas fa-print ms-1"></i> چاپ گزارش
                </a>
                <a href="<?php echo e(route('school.student-fees.notice-report', request()->query())); ?>"
                   target="_blank"
    ...
    <div class="px-3">
        <form method="GET" action="<?php echo e(route('school.student-fees.index')); ?>" class="row g-2 mb-4">
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                ...
                <select name="payment_status" class="form-select">
                    ...
                    <option value="paid"   <?php echo e(request('payment_status') == 'paid' ? 'selected' : ''); ?>>پرداخت شده</option>
                </select>
            </div>
            <div class="col-auto align-self-end">
                <button type="submit" class="btn btn-primary">اعمال</button>
                <a href="<?php echo e(route('school.student-fees.index')); ?>" class="btn btn-secondary">حذف فیلتر</a>
            </div>
        </form>
                ...
                <table class="table table-bordered table-hover mb-0" style="font-size: 12px;">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            ?>
                            <tr data-fees="<?php echo e($feesJson); ?>" data-payments="<?php echo e($paymentsJson); ?>">
                                ...
                                <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <td class="text-center <?php echo e($isPaid ? 'bg-success-light' : ($fee ? 'bg-warning-light' : '')); ?>">
                                        <?php if($fee): ?>
                                            <div><?php echo e(number_format($fee->amount)); ?></div>
                                            <?php if($isPaid): ?>
                                                <span class="badge bg-success">رسید</span>
                                                <?php if($lastPayment): ?>
                                                    <a href="<?php echo e(route('school.payments.payment-slip', $lastPayment->id)); ?>"
                                                       class="btn btn-sm btn-outline-secondary mt-1" target="_blank" title="رسید چاپی">
                                                        <i class="fas fa-print"></i>
                                                    </a>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <span class="text-danger"><?php echo e(number_format(($fee->amount - $fee->discount) - $paidAmount)); ?></span>
                                                <button class="btn btn-sm btn-outline-success mt-1 pay-btn"
                                                    ...
                                                    data-amount="<?php echo e($fee->amount - $fee->discount); ?>">
                                                    رسید
                                                </button>
                                            <?php endif; ?>
                                        <?php else: ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <td class="text-warning fw-bold"><?php echo e(number_format($totalDiscount)); ?></td>
                                <td class="text-success fw-bold"><?php echo e(number_format($totalPaidByStudent)); ?></td>
                                <td class="text-center">
                                    <a href="<?php echo e(route('school.student-fees.fee-preview', $student->id)); ?>" target="_blank" class="btn btn-sm btn-outline-secondary mb-1" title="پیش‌نمایش چاپ شهریه">
                                        <i class="fas fa-print"></i>
                                    </a>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-1">
                                        ...
                                        <form action="<?php echo e(route('school.students.destroy', $student->id)); ?>"
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr><td colspan="<?php echo e(9 + $months->count()); ?>" class="text-center text-muted py-3">دانش‌آموزی یافت نشد.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
                ...
                <form id="quickPaymentForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="modal_date" class="form-control" value="<?php echo e(\App\Helpers\JalaliHelper::todayJalali()); ?>" required>
                        </div>
                        <div class="col-md-4 mb-3">
...
<script>
    const monthNames = <?php echo json_encode($allMonths->pluck('name', 'id'), 512) ?>;
</script>
...
document.getElementById('submitQuickPayment').addEventListener('click', function() {
    ...
    fetch('<?php echo e(route('school.payments.store')); ?>', {
        method: 'POST',
...
document.querySelectorAll('.edit-payment-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        document.getElementById('goToEditPayment').onclick = function() {
            ...
            window.location.href = '<?php echo e(route("school.payments.edit", ":id")); ?>'.replace(':id', paymentId);
        };
...
document.querySelectorAll('.delete-fee-btn').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        select.addEventListener('change', function() {
            ...
            form.action = '<?php echo e(route("school.student-fees.destroy", ":id")); ?>'.replace(':id', feeId);
        });
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_finance_db\resources\views\school\student-fees\index.blade.php ENDPATH**/ ?>