...
<div class="receipt-container">
    ...
    <div class="header">
        ...
        <div class="school-name"><?php echo e($school->name ?? 'مکتب'); ?></div>
        <div class="receipt-title">رسید پیش‌پرداخت (مساعده)</div>
    </div>

    <table class="info-table">
        <tr><td class="label">نام کارمند</td><td class="value"><?php echo e($employeeAdvance->employee->first_name); ?> <?php echo e($employeeAdvance->employee->last_name); ?></td></tr>
        <tr><td class="label">ماه مقصد کسر</td><td class="value"><?php echo e($employeeAdvance->month->name ?? '—'); ?></td></tr>
        <tr><td class="label">تاریخ</td><td class="value"><?php echo e(\App\Helpers\JalaliHelper::toJalali($employeeAdvance->advance_date)); ?></td></tr>
        <tr><td class="label">مبلغ</td><td class="value"><?php echo e(number_format($employeeAdvance->amount)); ?> ؋</td></tr>
        <?php if($employeeAdvance->notes): ?>
        <tr><td class="label">توضیحات</td><td class="value"><?php echo e($employeeAdvance->notes); ?></td></tr>
        <?php endif; ?>
    </table>
...
<?php /**PATH E:\school_finance_db\resources\views\school\employee-advances\receipt.blade.php ENDPATH**/ ?>