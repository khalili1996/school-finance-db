<?php $__env->startSection('title', 'ویرایش معاش'); ?>
...
<div class="container-fluid px-4">
    ...
    <div class="card shadow">
        <div class="card-header bg-warning text-dark">
            <h5 class="mb-0"><i class="fas fa-edit ms-2"></i> ویرایش معاش</h5>
        </div>
        <div class="card-body">
            <?php if($errors->any()): ?>
            ...
            <form action="<?php echo e(route('school.salaries.update', $salary->id)); ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="employee_id" id="employee_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($emp->id); ?>" <?php echo e(old('employee_id', $salary->employee_id) == $emp->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="academic_year_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $academicYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ay->id); ?>" <?php echo e(old('academic_year_id', $salary->academic_year_id) == $ay->id ? 'selected' : ''); ?>><?php echo e($ay->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="term_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($term->id); ?>" <?php echo e(old('term_id', $salary->term_id) == $term->id ? 'selected' : ''); ?>><?php echo e($term->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="month_id" id="month_id" class="form-select">
                            ...
                            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m->id); ?>" <?php echo e(old('month_id', $salary->month_id) == $m->id ? 'selected' : ''); ?>><?php echo e($m->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="base_salary" id="base_salary" class="form-control" value="<?php echo e(old('base_salary', $salary->base_salary)); ?>" min="0" required>
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">اضافه‌کاری</label>
                        <input type="number" name="overtime_amount" id="overtime_amount" class="form-control" value="<?php echo e(old('overtime_amount', $salary->overtime_amount)); ?>" min="0">
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">پاداش</label>
                        <input type="number" name="bonus_amount" id="bonus_amount" class="form-control" value="<?php echo e(old('bonus_amount', $salary->bonus_amount)); ?>" min="0">
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">کسورات</label>
                        <input type="number" name="deduction_amount" id="deduction_amount" class="form-control" value="<?php echo e(old('deduction_amount', $salary->deduction_amount)); ?>" min="0">
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">ضمانت</label>
                        <input type="number" name="guarantee_amount" id="guarantee_amount" class="form-control" value="<?php echo e(old('guarantee_amount', $salary->guarantee_amount)); ?>" min="0">
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">مبلغ مالیات (افغانی)</label>
                        <input type="number" name="tax_amount" id="tax_amount" class="form-control" value="<?php echo e(old('tax_amount', $salary->tax_amount)); ?>" min="0" step="0.01">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="status" class="form-select" required>
                            <option value="unpaid" <?php echo e(old('status', $salary->status) == 'unpaid' ? 'selected' : ''); ?>>پرداخت نشده</option>
                            <option value="partially_paid" <?php echo e(old('status', $salary->status) == 'partially_paid' ? 'selected' : ''); ?>>پرداخت جزئی</option>
                            <option value="paid" <?php echo e(old('status', $salary->status) == 'paid' ? 'selected' : ''); ?>>پرداخت کامل</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" id="advance_sum_display" class="form-control" readonly value="<?php echo e($currentAdvanceSum); ?>">
                    </div>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="notes" class="form-control" rows="2"><?php echo e(old('notes', $salary->notes)); ?></textarea>
                    </div>
                </div>
...
function calculateAll() {
    ...
    const net = gross - tax - guarantee - advanceSum;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_finance_db\resources\views\school\salaries\edit.blade.php ENDPATH**/ ?>