<?php $__env->startSection('title', 'ایجاد صندوق جدید'); ?>
...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <form action="<?php echo e(route('school.cashboxes.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="cash" <?php echo e(old('type') == 'cash' ? 'selected' : ''); ?>>نقدی</option>
                            <option value="bank" <?php echo e(old('type') == 'bank' ? 'selected' : ''); ?>>بانکی</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('initial_balance', 0)); ?>" min="0" required>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_finance_db\resources\views\school\cashboxes\create.blade.php ENDPATH**/ ?>