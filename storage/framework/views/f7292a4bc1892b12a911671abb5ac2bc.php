...
<div class="receipt-container">
    ...
    <div class="header">
        ...
        <div class="receipt-title">
            ...
            <?php elseif($transaction->type === 'withdrawal'): ?>
                رسید برداشت از صندوق
            <?php else: ?>
                رسید انتقال بین صندوق‌ها
            <?php endif; ?>
        </div>
    </div>
    ...
    <table class="info-table">
        <tr>
            ...
            <td class="value"><?php echo e($transaction->id); ?></td>
        </tr>
        <tr>
            <td class="label">تاریخ</td>
            <td class="value"><?php echo e($transaction->transaction_date); ?></td>
        </tr>
        <tr>
            <td class="label">نوع تراکنش</td>
            <td class="value">
                <?php if($transaction->type === 'deposit'): ?>
                    واریز (افزایش موجودی)
                <?php elseif($transaction->type === 'withdrawal'): ?>
        ...
        <tr>
            <td class="label">صندوق</td>
            <td class="value"><?php echo e($transaction->cashbox->name ?? '—'); ?></td>
        </tr>
        <?php if($transaction->description): ?>
        <tr>
            <td class="label">شرح</td>
            <td class="value"><?php echo e($transaction->description); ?></td>
        </tr>
        <?php endif; ?>
        <tr>
            <td class="label">مبلغ</td>
            <td class="value"><?php echo e(number_format($transaction->amount)); ?> ؋</td>
        </tr>
        <?php if($transaction->type === 'transfer'): ?>
        <tr>
            <td class="label">صندوق مقصد</td>
            <td class="value"><?php echo e($transaction->toCashbox->name ?? '—'); ?></td>
        </tr>
        <?php endif; ?>
    </table>
...
<?php /**PATH E:\school_finance_db\resources\views\school\cashbox_transactions\receipt.blade.php ENDPATH**/ ?>