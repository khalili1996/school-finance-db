<?php $__env->startSection('title', 'ویرایش پیش‌پرداخت'); ?>
...
<div class="container-fluid px-4">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('school.employee-advances.update', $employeeAdvance)); ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="employee_id" class="form-select" required>
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($emp->id); ?>" <?php echo e(old('employee_id', $employeeAdvance->employee_id) == $emp->id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="month_id" class="form-select" required>
                            ...
                            <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($m->id); ?>" <?php echo e(old('month_id', $employeeAdvance->month_id) == $m->id ? 'selected' : ''); ?>>
                                    <?php echo e($m->name); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="amount" class="form-control"
                               value="<?php echo e(old('amount', $employeeAdvance->amount)); ?>" min="1" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label class="form-label">تاریخ <span class="text-danger">*</span></label>
                        <input type="text" name="advance_date" class="form-control"
                               value="<?php echo e(old('advance_date', $employeeAdvance->advance_date)); ?>" required>
                    </div>

                    <div class="col-12 mb-3">
                        <label class="form-label">توضیحات</label>
                        <textarea name="notes" class="form-control" rows="2"><?php echo e(old('notes', $employeeAdvance->notes)); ?></textarea>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_finance_db\resources\views\school\employee-advances\edit.blade.php ENDPATH**/ ?>