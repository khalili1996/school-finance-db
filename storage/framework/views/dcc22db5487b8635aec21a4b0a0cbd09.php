<?php $__env->startSection('title', 'ثبت مصرف جدید'); ?>
...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('school.expenses.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="paid_amount" class="form-control" value="<?php echo e(old('paid_amount', 0)); ?>" min="0">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="expense_date" class="form-control"
                               value="<?php echo e(old('expense_date', \App\Helpers\JalaliHelper::todayJalali())); ?>"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="status" class="form-select" required>
                            <option value="due" <?php echo e(old('status') == 'due' ? 'selected' : ''); ?>>بدهکار</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="quantity" class="form-control" value="<?php echo e(old('quantity')); ?>" min="0">
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">واحد</label>
                        <input type="text" name="unit" class="form-control" value="<?php echo e(old('unit')); ?>" placeholder="مثلاً عدد، کیلوگرام">
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">دریافت‌کننده</label>
                        <input type="text" name="received_by" class="form-control" value="<?php echo e(old('received_by')); ?>">
                    </div>

                    
                    <div class="col-md-4 mb-3">
                        <label class="form-label">مصرف‌کننده</label>
                        <input type="text" name="consumer_name" class="form-control" value="<?php echo e(old('consumer_name')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_finance_db\resources\views\school\expenses\create.blade.php ENDPATH**/ ?>