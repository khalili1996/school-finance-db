...
<table>
    <tr><td class="label">کد دانش‌آموز</td><td class="value"><?php echo e($payment->student->student_code); ?></td></tr>
    <tr><td class="label">نام دانش‌آموز</td><td class="value"><?php echo e($payment->student->first_name); ?> <?php echo e($payment->student->last_name); ?></td></tr>
    <tr><td class="label">نام پدر</td><td class="value"><?php echo e($payment->student->father_name); ?></td></tr>
    <tr><td class="label">صنف</td><td class="value"><?php echo e($payment->student->class ?? '—'); ?></td></tr>
    <?php if($payment->studentFee && $payment->studentFee->month): ?>
    <tr><td class="label">ماه</td><td class="value"><?php echo e($payment->studentFee->month->name); ?></td></tr>
    <?php endif; ?>
    <tr><td class="label">مبلغ شهریه (این ماه)</td><td class="value"><?php echo e(number_format($payment->studentFee->amount ?? 0)); ?> ؋</td></tr>
    <tr><td class="label">مبلغ پرداختی</td><td class="value"><?php echo e(number_format($payment->amount)); ?> ؋</td></tr>
    <?php
        $remaining = 0;
    ...
    ?>
    <tr><td class="label">باقی‌مانده</td><td class="value"><?php echo e(number_format(max($remaining, 0))); ?> ؋</td></tr>
    <tr><td class="label">تاریخ پرداخت</td><td class="value"><?php echo e(\App\Helpers\JalaliHelper::toJalali($payment->payment_date)); ?></td></tr>
</table>
...
<?php /**PATH E:\school_finance_db\resources\views\school\student-fees\payment-slip.blade.php ENDPATH**/ ?>