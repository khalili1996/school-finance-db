<?php $__env->startSection('title', 'ثبت ولی جدید'); ?>
...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('school.guardians.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="relation" class="form-select">
                            ...
                            <option value="father" <?php echo e(old('relation') == 'father' ? 'selected' : ''); ?>>پدر</option>
                            <option value="mother" <?php echo e(old('relation') == 'mother' ? 'selected' : ''); ?>>مادر</option>
                            <option value="brother" <?php echo e(old('relation') == 'brother' ? 'selected' : ''); ?>>برادر</option>
                            <option value="uncle" <?php echo e(old('relation') == 'uncle' ? 'selected' : ''); ?>>کاکا / ماما</option>
                            <option value="other" <?php echo e(old('relation') == 'other' ? 'selected' : ''); ?>>سایر</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="secondary_phone" class="form-control" value="<?php echo e(old('secondary_phone')); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="job" class="form-control" value="<?php echo e(old('job')); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">تحصیلات</label>
                        <input type="text" name="education" class="form-control" value="<?php echo e(old('education')); ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">وضعیت</label>
                        <select name="is_active" class="form-select">
                            <option value="1" <?php echo e(old('is_active', '1') == '1' ? 'selected' : ''); ?>>فعال</option>
                            <option value="0" <?php echo e(old('is_active', '1') == '0' ? 'selected' : ''); ?>>غیرفعال</option>
                        </select>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\school_finance_db\resources\views\school\guardians\create.blade.php ENDPATH**/ ?>