...
<div class="receipt-container">
    ...
    <div class="header">
        ...
        <div class="receipt-title">رسید پرداخت معاش</div>
    </div>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="value"><?php echo e($payment->payment_date); ?></td>
        </tr>
        <tr>
            <td class="label">نام کارمند</td>
            <td class="value"><?php echo e($payment->salary->employee->first_name); ?> <?php echo e($payment->salary->employee->last_name); ?></td>
        </tr>
        <tr>
            <td class="label">ماه</td>
            <td class="value"><?php echo e($payment->salary->month->name ?? '—'); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="value"><?php echo e($payment->cashbox->name ?? '—'); ?></td>
        </tr>
        <?php if($payment->notes): ?>
        <tr>
            <td class="label">توضیحات</td>
            <td class="value"><?php echo e($payment->notes); ?></td>
        </tr>
        <?php endif; ?>
    </table>
...
<?php /**PATH E:\school_finance_db\resources\views\school\salary_payments\receipt.blade.php ENDPATH**/ ?>